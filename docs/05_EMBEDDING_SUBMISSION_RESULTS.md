...
**ベース**: 現時点最高 **movie_title_info + PCA 16**（Public 0.75449）。いずれもこの設定を土台にしている。
...
| ファイル | 役割 |
|----------|------|
| **`quick_embedding_submissions.ipynb`** | **ベース = 0.75449。** 上から実行で 11 本（ベース + seed_avg, pca24, large_pca16, ensemble_two, publisher_freq, lda_10, doc_x_critic_te, pca32, pca8, blend_pca16_pca24）を一括作成。 |
